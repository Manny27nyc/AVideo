...
use Google\Service\Connectors\ListLocationsResponse;
use Google\Service\Connectors\Location;
use Google\Service\Connectors\RuntimeConfig;
...
class ProjectsLocations extends \Google\Service\Resource
{
   ...
   * for each location. (locations.getRuntimeConfig)
   *
  ...
  public function getRuntimeConfig($name, $optParams = [])
  {
    $params = ['name' => $name];
    $params = array_merge($params, $optParams);
    return $this->call('getRuntimeConfig', [$params], RuntimeConfig::class);
  }
  /**
